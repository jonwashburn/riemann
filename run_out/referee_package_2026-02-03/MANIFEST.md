# Referee package (internal) — Riemann zero-free region
...
- `paper/paper1_pplus_proof.tex` — appendix source (input by the main file)
- `paper/riemann_common_preamble.tex` — shared preamble
- `paper/riemann_bibliography.tex` — bibliography

### Markup convention
- Blue text blocks: referee notes / dependency mapping
- Green text blocks (`\rev{...}` / `greentext`): author revisions responding to referee notes
