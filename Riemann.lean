...
-- Physics/SpinGlass bridge (`Riemann/PhysLean/SpinGlass/`)
...
-- Local Mathlib extensions (`Riemann/Mathlib/`)
import Riemann.Example
import Riemann.Mathlib.Analysis.Analytic.PowerSeriesCoefficients
import Riemann.Mathlib.Analysis.Calculus.TaylorIntegral -- from Moritz Doll PR
import Riemann.Mathlib.Analysis.Complex.Cartan -- from sorried file in VD
...
@ -85,33 +23,37 @@ import Riemann.Mathlib.Analysis.Complex.DeBranges.Nevanlinna.PosLogLemmas
...
@ -119,34 +61,37 @@ import Riemann.Mathlib.Analysis.Harmonic.BMO.Lp
...
-- import Riemann.Mathlib.Analysis.Normed.Operator.Fredholm.Compact  -- from Michael Rothgang PR
-- import Riemann.Mathlib.Analysis.Normed.Operator.Fredholm.Defs -- from Michael Rothgang PR
...
import Riemann.Mathlib.MeasureTheory.Integral.Carleson.Backup
import Riemann.Mathlib.MeasureTheory.Integral.CauchyProduct
import Riemann.Mathlib.MeasureTheory.Integral.PoissonParameter
import Riemann.Mathlib.MeasureTheory.Integral.RationalIntegrals
@ -154,50 +99,64 @@ import Riemann.Mathlib.MeasureTheory.Measure.Carleson.Defs
...
-- import Riemann.Mathlib.NumberTheory.LSeries.RiemannZeta

import Riemann.Mathlib.NumberTheory.LSeries.RiemannZeta
import Riemann.Mathlib.Probability.Distributions.AbstractCompletion
import Riemann.Mathlib.Probability.Distributions.Basic
import Riemann.Mathlib.Probability.Distributions.CameronMartin
import Riemann.Mathlib.Probability.Distributions.CameronMartinThm
import Riemann.Mathlib.Probability.Distributions.ClosedSubmodule
import Riemann.Mathlib.Probability.Distributions.CompletionResultsToBeMoved
import Riemann.Mathlib.Probability.Distributions.CovarianceBilinDual
...
import Riemann.Mathlib.Probability.Distributions.Real
import Riemann.Mathlib.Probability.Distributions.Variance
import Riemann.Mathlib.Topology.FilterNhdsWithin

-- Semiclassical (`Riemann/Semiclassical/`)
...
@ -209,12 +168,34 @@ import Riemann.Semiclassical.TwoChart_SmoothUpgrade
...
-- Weil explicit-formula track (`Riemann/Weil/`)
