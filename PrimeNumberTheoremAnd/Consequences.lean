...
local notation "ω" => ArithmeticFunction.cardDistinctFactors
local notation "ζ" => ArithmeticFunction.zeta
...
-- theorem lambda_pnt : (fun x : ℝ ↦ ∑ n ∈ range ⌊x⌋₊, (-1)^(ArithmeticFunction.cardFactors n)) =o[atTop] fun x ↦ x := by
--  sorry
