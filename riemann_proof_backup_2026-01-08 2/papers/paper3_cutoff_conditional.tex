...
In applying the near-field barrier closure argument of Paper~II on the range of scales $0<L\le 0.2$, assume that the argument may be run using a family of test functions $\Phi_{L,t_0}$ which satisfies Hypothesis~\ref{hyp:nyquist-cutoff} for all relevant pairs $(L,t_0)$.
\end{hypothesis}
